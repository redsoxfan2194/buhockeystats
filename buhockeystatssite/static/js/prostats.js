console.log("loading prostats.js");
...
function clearFilters(event) {
    ...
    if (document.getElementById("league").value === "PWHL") {
        document.getElementById("seasonStart").value = "2023-24";
    } else {
        const option = document.createElement("option");
        option.value = "1957-58";
        option.textContent = "1957-58";
...
function submitForm(reset = "false") {
    const formData = $("#playerProForm").serialize();

    $.ajax({
        url: $("#playerProForm").attr("action"),
        method: $("#playerProForm").attr("method"),
        data: formData,
